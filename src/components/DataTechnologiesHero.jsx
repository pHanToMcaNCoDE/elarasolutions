...
const TechnologiesHero = ({title, desc, heroImg, menuTitle, subTitle }) => {
  return (
        ...
        <div className='max-w-[1280px] mx-auto flex flex-col md:flex-row justify-between items-center gap-10'>
            <div className='w-full md:w-[50%] lg:w-[500px] flex flex-col justify-center items-start gap-[24px] lg:gap-[48px]'>
                <div className='flex flex-col justify-center items-start gap-[12px]'>
                    ...
                    <h1 className='w-full text-blue font-bold leading-[35px] lg:leading-[60px] text-[1.75rem] lg:text-[3rem] font-instrument'>{title}</h1>
                </div>
                <p className='lg:w-full text-blueTwo font-normal text-[1rem] leading-[28.8px] font-instrument'>
                    {desc} 
                </p>
