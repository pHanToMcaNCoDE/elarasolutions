  ...
  return (
    <section className='bg-white py-[80px] lg:py-[120px] px-[24px] lg:px-[100px] min-h-screen'>
        <div className='max-w-[1280px] mx-auto flex flex-col justify-center items-center gap-[40px] lg:gap-[80px] min-h-screen'>
            <h1 className={`text-blue font-semibold leading-[31.2px] lg:leading-[50px] text-[1.5rem] lg:text-[2.5rem] w-[328px] ${pathname === '/compliance-and-risk-management' || pathname === '/endpoint-security' ? 'lg:w-[656px]' : 'lg:w-[585px]'} gap-[12px] flex justify-center items-center text-center font-instrument`}>{header}</h1>
