  ...
  return (
    <section className='bg-white gap-[96px] py-[120px] px-[46px] flex flex-col justify-center items-center'>
        <div className='w-[328px] md:w-full lg:w-[868px] flex flex-col justify-center items-center text-center gap-[12px] font-instrument'>
            <h2 className={`uppercase text-greenTwo text-[.75rem] leading-[12px] font-medium font-instrument`}>customers</h2>
            <h1 className='w-full text-blue font-semibold leading-[39.04px] md:leading-[77.13px] text-[2rem] md:text-[3rem] font-instrument'>Success Stories</h1>
...
export default ProductsSuccessStories